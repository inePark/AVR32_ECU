...
#define MNS_P_SRV_FREE10        ((word) 0x0200)
#define MNS_P_SRV_FREE11        ((word) 0x0400)
#define MNS_P_SRV_FREE12        ((word) 0x0800)
#define MNS_P_SRV_FREE13        ((word) 0x1000)
#define MNS_P_SRV_FREE14        ((word) 0x2000)
...
#define MNS_P_SRV_LAST     ((word) 0x0100)

#define MNS_P_SRV_COMM   (word) ( MNS_P_SRV_PMS  | MNS_P_SRV_MIS  | MNS_P_SRV_AMS  )
#define MNS_P_SRV_BASE   (word) ( MNS_P_SRV_COMM | MNS_P_SRV_MNS  | MNS_P_SRV_WADS )
...
#define MNS_P_SRV_ALL_RESET (word) (MNS_P_SRV_ALL & ~( MNS_P_SRV_PMS  | MNS_P_SRV_MIS  | MNS_P_SRV_WADS  ))
...
#define MNS_P_PM_DONE               ((word) 0x1000)
#define MNS_P_SRV_CHECK             ((word) 0x2000)
#define MNS_P_AS_GO_NET_OFF         ((word) 0x4000)
#define MNS_P_FIRST                     MNS_P_ALL_SERVICES_READY
#define MNS_P_LAST                      MNS_P_AS_GO_NET_OFF
...
typedef struct TNetServicesConfig
{
    ...
    struct TMsgConfig
    {
        ...
        byte (*tx_out_filter_fptr)(TMsgTx *msg_ptr);
        #endif
...
typedef struct TMostVersionInfo
{
    ...
    /*! Clear the value of a timer (set to zero without fireing the event).
      ...
      */
    #define MostClearTimer(timer_ptr) MostSetTimer((TMostTimer *)timer_ptr, (word)0, MNS_FALSE)
#endif
