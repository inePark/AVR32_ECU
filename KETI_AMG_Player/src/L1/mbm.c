...
*/
    ...
    byte               mbmMemArray[MBM_MEM_UNIT_SIZE * MBM_MEM_UNIT_NUM];
...
static _INLINE void MbmSendMdmMbmBufferAllocationFailed(word type)
{
    ...
    /*! Grab only low Byte of message type */
    tmp = (byte)(type & (word)0x00FF);

    MdmMsgSendMns(MDM_MBM_BUFFER_ALLOCATION_FAILED, &tmp, (byte)1);
