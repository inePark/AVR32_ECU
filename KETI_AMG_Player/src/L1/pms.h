...
==============================================================================
*/
#define PMS_ALIGN(n,a)      ((((n)+(a))-1)&~((a)-1))
...
typedef struct PmsInitStruct
{
    ...
    byte (*cbTxOutFilter_fptr)(TMsgTx *msg_ptr);            /*!< TX out filter (post-Queue) */
#endif
...
#ifdef PMS_56
    void PmsHandleRetryParamsStatus(TMsgRx *msg_ptr);
#endif

#ifdef PMS_57
    void PmsHandleMidLevelRetriesStatus(TMsgRx *msg_ptr);
#endif
