             ...
             )
{
    ...
    #if (defined PACKET_COMMUNICATION_ONLY) || ((!defined AMS_TX_BYPASS_FILTER) && (!defined NS_AMS_MSV2)              && (!defined AMS_TX_OUT_FILTER) && (!defined MSG_TX_USER_PAYLOAD) && (!defined MSG_RX_USER_PAYLOAD))
    (void)msg_cfg_ptr;
    #endif
