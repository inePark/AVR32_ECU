...
#define MX_AMS_PE            10
#define MX_AMS_CS            11
#define MX_AMS_TX_Q          12
#define MX_AMS_RX_Q          13

#define MX_ADS_PE            14
#define MX_ADS_RX_Q          15

#define MX_VMSV_PE           16
#define MX_VMSV_CS           17

#define MX_WMCS_PE           18
#define MX_WMCS_CS           19

#define MX_WSCM_PE           20
#define MX_WSCM_CS           21

#define MX_AAM_PE            22
#define MX_AAM_TX_Q          23

#define MX_MDM_Q             24
#define MX_MDM_CS            25

#define MNS_REQUIRED_MUTEXES 26
...
#define NST_C_INIT              0x0001 /* Init runs            */
#define NST_C_STATES            0x0002 /* state changes        */
#define NST_C_TX                0x0004 /* TX messages          */
#define NST_C_RX                0x0008 /* RX messages (MIS)    */
#define NST_C_RX_MORE           0x0010 /* RX messages (AMS)    */
#define NST_C_SERVICE           0x0020 /* Service runs         */
#define NST_C_REQUESTS          0x0040 /* Service requests     */
#define NST_C_MOST_INIT         0x0080 /* InitNetServices      */
#define NST_C_MOST_SERVICE      0x0100 /* MostService runs     */
#define NST_C_MOST_REQUESTS     0x0200 /* MostService requests */
#define NST_C_BUF_USAGE         0x0400 /* Buffer usage info    */
#define NST_C_FUNC_ENTRIES      0x0800 /* Function entries     */
#define NST_C_FUNC_EXITS        0x1000 /* Function exits       */
#define NST_C_OPT_INFO          0x2000 /* Optimization infos   */
#define NST_C_MISC              0x4000 /* all the rest ...     */
#define NST_C_ASSERTS           0x8000 /* Enable ASSERTs       */

#define NST_L_NOTHING       0x0000
...
#define NST_L_EVERYTHING    0xFFFF
...
#define MNS_BYTE_BITS 8
#define MNS_WORD_BITS (2*MNS_BYTE_BITS)

typedef word TMnsResult;           /* may only change into > 16 bits ! */

#define NSR_BITS             (sizeof(TMnsResult) * MNS_BYTE_BITS)

#define NSR_FAILURE_BIT      ((TMnsResult)(1 << /*lint -save -e778*/ (NSR_BITS-1) /*lint -restore*/ ))
#define NSR_SUCCESS(x)       (((x & NSR_FAILURE_BIT) ? MNS_FALSE : MNS_TRUE))
#define NSR_FAILURE(x)       (((x & NSR_FAILURE_BIT) ? MNS_TRUE : MNS_FALSE))
#define NSR_CODE_BYTE(x)     ((byte)((x & (~NSR_FAILURE_BIT)) >> (NSR_BITS-MNS_BYTE_BITS)))
#define NSR_EXT_CODE_BYTE(x) ((byte)((x & (~NSR_FAILURE_BIT)) >> /*lint -save -e778*/ (NSR_BITS-(2*MNS_BYTE_BITS))/*lint -restore*/))

#define NSR_BUILD_S(s)       ((TMnsResult)(s ? 0 : NSR_FAILURE_BIT))
#define NSR_BUILD_C(c)       ((TMnsResult)((((byte)c) & ~(1<</*lint -save -e778*/(MNS_BYTE_BITS-1)/*lint -restore*/)) << (/*lint -save -e778*/NSR_BITS-MNS_BYTE_BITS/*lint -restore*/)))
#define NSR_BUILD_E(e)       ((TMnsResult)(e << /*lint -save -e778*/(NSR_BITS-(2*MNS_BYTE_BITS))/*lint -restore*/))
...
#define NSR_E_PACKET_IN                     NSR_BUILD(MNS_FALSE, 0xAC, 0x04)
#define NSR_E_PACKET_OUT                    NSR_BUILD(MNS_FALSE, 0xAC, 0x05)
...
#define MNS_F_ALLOW_AUTO_CONFIG             ((word) 0x0008)
