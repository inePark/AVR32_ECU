...
#define MSG_SRC_INIC                    ((word) 0x0001)
    ...
    #define MOST_TGT_INTERN     MSG_TGT_EHC
    #define MOST_SRC_INTERN     MSG_SRC_EHC
#endif
...
#define XMIT_TX_FILTER          ((byte) 0x88)
